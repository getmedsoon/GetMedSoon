...
public abstract class AbstractGetNameTask extends AsyncTask<Void, Void, Void> {
   ...
   public static String GOOGLE_USER_DATA="No_data";
	...
	AbstractGetNameTask(SplashScreen activity, String email, String scope,SharedPreferences settings) {
       // System.out.println("Enters Second");
	...
	protected Void doInBackground(Void... params) {
		try {
           // System.out.println("Enters Fetch");
	...
	private void fetchNameFromProfileServer() throws IOException, JSONException {
		...
		if (sc == 200) {
           // System.out.println("Enters Fucnt");
			InputStream is = con.getInputStream();
			GOOGLE_USER_DATA = readResponse(is);
			is.close();
            HomeActivity gD=new HomeActivity();
            gD.googgleDetails(mEmail,mActivity,settings);
            //System.out.println("Before Making value false");
